...
import { pauseCampaign } from "../../../../../lib/broadcast/machine";
...
/**
 * POST /admin/api/email-campaigns/[id]/pause — jeda pengiriman (sending → paused).
...
export const POST: APIRoute = async ({ cookies, params, request }) => {
  ...
  const result = await pauseCampaign(params.id ?? "", { adminUserId: admin.id, ip });
